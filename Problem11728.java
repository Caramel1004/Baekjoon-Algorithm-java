...
public class Problem11728 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<Integer> list = new ArrayList<>(Integer.parseInt(st.nextToken()) + Integer.parseInt(st.nextToken()));
        ...
        while (true) {
            ...
            if (Integer.parseInt(arrA[ptrA]) < Integer.parseInt(arrB[ptrB])) {
                list.add(Integer.parseInt(arrA[ptrA]));
                ptrA++;
            } else {
                list.add(Integer.parseInt(arrB[ptrB]));
                ptrB++;
            }
        }
